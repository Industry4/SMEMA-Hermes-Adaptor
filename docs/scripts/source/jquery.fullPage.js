    ...
    $.fn.fullpage = function(options) {
        ...
        */
        ...
        function createSlimScrolling(element){
            ...
            var scrollHeight = windowsHeight - parseInt(section.css('padding-bottom'), 10) - parseInt(section.css('padding-top'), 10);
        ...
        function getTableHeight(element){
            ...
            if(options.paddingTop || options.paddingBottom){
                ...
                var paddings = parseInt(section.css('padding-top'), 10) + parseInt(section.css('padding-bottom'), 10);
